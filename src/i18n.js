...
export const STRINGS = {
  en: {
    ...
    'welcome.step2': '<b>Steer with the mast</b> — rake back ◀ turns you upwind, rake forward ▶ turns you downwind. No rudder!',
  ...
  uk: {
    ...
    'welcome.step2': '<b>Стернуйте щоглою</b> — нахил назад ◀ приводить до вітру, нахил вперед ▶ уводить під вітер. Стерна немає!',
